...
function MemberEditProfile() {
  ...
  const handleImgUpdate = async (e) => {
    ...
    try {
      const response = await axios.put(
        "https://ground-reservation-apis-production.up.railway.app/api/member/profile/change-image",
        formData,
        {
          headers: {
  ...
  const updateDetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        "https://ground-reservation-apis-production.up.railway.app/api/member/profile/change-details",
        data,
        {
          headers: {
